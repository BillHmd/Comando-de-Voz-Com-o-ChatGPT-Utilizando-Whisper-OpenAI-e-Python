# -*- coding: utf-8 -*-
"""Comando-de-Voz-Com-o-ChatGPT-Utilizando-Whisper-OpenAI-e-Python.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Hopz1rqm15TFfAgAFEfb9cPVhKpzVpDy

# **1. Gravação e captação de Áudio utilizando Python e Javascript**
"""

# Projeto do Dio.me para o curso de Dados e IA
...
# Código JavaScript para gravar áudio usando a "MediaStream Recording API"
RECORD = """
...
def record(sec=5):
  # Executa o código JavaScript para iniciar gravação
...
# Grava o áudio do usuário por um tempo determinado (6 segundos)
print('Ouvindo...\n')
record_file = record()
...
"""# **2. Reconhecendo a Fala com Whisper (OpenAI)**
...
"""# **3. Integração via API do ChatGPT**"""
...
"""# **4. Usando gTTS para Sintetizar a Resposta do ChatGPT Como Voz**"""
